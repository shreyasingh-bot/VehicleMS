...
<div class="container">
  <center><h2>Welcome Lender <span style="color:#dd7ff3;"><?php echo $_SESSION['name']; ?> !<br><h2>Chat with Vehicle Borrower</h2></span></h2>
  </center></br>
...
?>
  ...
  <form class="form-horizontal" method="post" action="sendMessage.php">
    <div class="form-group">
	  ...
	  <button type="submit" class="btn btn-danger" style="margin-left:500px"><a href="del_chat.php" style="color:white">End Chat</a></button>
		<h6 style="margin-left:200px">*make sure to end chat after completion only</h6>
    </div>
  </form>
</div>
